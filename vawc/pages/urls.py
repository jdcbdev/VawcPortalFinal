...
urlpatterns = [
    ...
    path('request_account_reset/', views.request_account_reset, name='request_account_reset'),
    path('admin-vawc/manage/account-reset-requests/', views.manage_account_resets_view, name='manage_account_resets'),
    path('admin-vawc/manage/resolve-reset-request/<int:request_id>/', views.resolve_reset_request, name='resolve_reset_request'),
    path('admin-vawc/manage/reset-account-password/<int:account_id>/', views.reset_account_password, name='reset_account_password'),
